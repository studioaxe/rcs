...
"""
sync.py - v1.6 CORRIGIDA DEFINITIVAMENTE

BUG CRÍTICO RESOLVIDO:
- ✅ to_date() agora trata vDDDTypes corretamente
- ✅ Extrai data de dtstart.dt para objetos icalendar
- ✅ MANUAL-REMOVE agora funciona 100%
"""
...
def fetch_all_calendars() -> Optional[Dict[str, Optional[Calendar]]]:
    ...
    if all(v is None for v in calendars.values()):
        log_error("ERRO: Nenhum calendário foi importado")
        return None
    return calendars
