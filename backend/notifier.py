...
"""
backend/notifier.py - Notificações de Sincronização (v3.2.4 FINAL PATCH)

Email Notifier para sincronização de calendários.
...
Uso:
    ...
    notifier.send_error("Error message", "sync.log")
    notifier.send_daily_report({'total_events': 15, 'success_count': 10, ...})

Versão: 3.2.4 FINAL PATCH
    ...
    def _attach_file(self, msg: MIMEMultipart, file_path: str) -> None:
        ...
        try:
            ...
            with open(file_path, "rb") as attachment:
                ...
                # ✅ CORRIGIDO: RFC 5987 compliant filename format
                part.add_header(
                    "Content-Disposition",
...
Sistema de Sincronização v3.2.4 FINAL PATCH
